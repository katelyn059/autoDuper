...
public enum LayoutMode implements TranslatableOption {
    TOP_LEFT(0, "wakduper.format.default"),
    TOP_RIGHT(1, "wakduper.format.topright"),
    BOTTOM_LEFT(2, "wakduper.format.bottomleft"),
    BOTTOM_RIGHT(3, "wakduper.format.bottomright"),
    NONE(4, "wakduper.format.disabled");
